---
title: "Financial Risk Classification Using SVM and XGBoost"
...
This project investigates multiclass financial-risk classification using
Support Vector Machines and XGBoost.

The workflow includes data-quality assessment, missing-value treatment,
exploratory data analysis, class-imbalance handling with SMOTE, model
training, hyperparameter tuning and performance evaluation.

The project was originally developed as part of the MSc Data Science and
Analytics programme at Brunel University London and was subsequently
reorganised for portfolio presentation.
...
```{r}
# Load the dataset
financial_df <- read.csv("../data/financial_risk_assessment.csv")
